...
- [x] 1.1 Add `limit`/`offset` query params and a
...
- [x] 2.1 Change `metrics.Service.ListUnhealthySteps` to
...
- [x] 3.1 Add `pipelineStepsGroupListDTO{Groups
...
- [x] 4.1 Update `web/src/routes/steps/+page.svelte`'s fetch to read
...
- [x] 4.2 Add a Previous/Next `Button` pair mirroring the Pipelines
...
- [x] 4.3 Update the empty-state and grouped-by-repo rendering to read
